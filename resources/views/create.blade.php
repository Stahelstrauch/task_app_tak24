...
@section('title', 'Lisa uus ülesanne')
...
@section('content')
    ...
    <form action="{{ route('store') }}" method="post" class="space-y-4">
        ...
        <div>
            <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Salvesta</button>
            <a href="{{ route('welcome') }}" class="ml-2 text-blue-600 hover:underline">Katkesta</a>
        </div>
